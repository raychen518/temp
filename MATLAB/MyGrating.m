...
degreesList = [45, 135];
tiltInDegrees = degreesList(randi(length(degreesList))); % The tilt of the grating in degrees.
...
% the gaussian mask.
periodsCoveredByOneStandardDeviation = 11.5;
